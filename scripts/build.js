...
function findWorkspaceRoot(startDir) {
  ...
  return projectRoot; // Fallback to project root if no workspace is found
}
...
function getDeploymentDomain() {
  ...
  console.warn(
    `WARNING: No deployment domain found. Falling back to localhost:${port}. ` +
      "To customize, set REPLIT_INTERNAL_APP_DOMAIN, REPLIT_DEV_DOMAIN, or EXPO_PUBLIC_DOMAIN",
  );
